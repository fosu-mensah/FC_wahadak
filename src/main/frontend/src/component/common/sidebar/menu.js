...
"sub",
    path
:
`${process.env.PUBLIC_URL}/ecommerce-app/product`,
    active
:
false,
    children
...
"sub",
    path
:
`${process.env.PUBLIC_URL}/pages/sample-page`,
    active
:
false,
    children
...
title: "UI Kits",
    icon
:
<i className="pe-7s-portfolio pe-lg"></i>,
    type
:
"sub",
    path
:
`${process.env.PUBLIC_URL}/ui-element/typography`,
    active
:
false,
    bookmark
